...
### 📊 High-Impact Fraud Detection Model
...
* **Strategic Optimization:** Optimized the model for the **F-beta score ($\beta=20$)**—a metric explicitly weighting **Recall** over Precision—to heavily penalize high-cost false negatives.
...
### 🗺️ Full-Waveform Inversion (FWI) for Geophysical Imaging
...
## 💻 Foundational Systems & Learning

---

### 📝 Foundational Deep Learning: GPT-2 Clone
